    ...
    const fetchData = async () => {
      try {
        ...
        const [courseRes, studentsRes] = await Promise.all([
          axios.get(`${import.meta.env.VITE_API_URL || "https://mernverse-1.onrender.com"}/api/courses/${id}`, config),
          axios.get(`${import.meta.env.VITE_API_URL || "https://mernverse-1.onrender.com"}/api/courses/${id}/students`, config)
        ]);
